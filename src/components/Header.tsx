                ...
                <div id="image-container" style={{ display: "none" }}>
                  <div class="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-500 bg-opacity-50">
                    ...
                    onClick={handleCloseClick}>X</button>
                      <div class="text-xl font-bold mb-4">尊敬的用户，您好！非常感谢您的支持，您可以选择三种订阅策略：19元/月，39元/三个月，69元/半年。订阅周期为每个月的19号至次月19号。<br/>和其他平台不一样的是，在订阅期间内，没有使用次数限制，您可以尽情使用~<br/>请选择适合您的方式扫码转账，转账时务必备注您的邮箱地址或者手机号，在完成转账后的 5-30 分钟内，网站密码会以短信或者邮件的形式发送给您，请注意查收。<br/>点击任意图片可以关闭弹窗</div>
